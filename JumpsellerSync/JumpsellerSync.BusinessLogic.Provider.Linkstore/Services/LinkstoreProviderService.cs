...
namespace JumpsellerSync.BusinessLogic.Provider.Linkstore.Services
{
        ...
        : ProviderService<LinkstoreProduct, LinkstoreBrand, LinkstoreConfiguration, LinkstoreProviderService>
    {
        ...
        private IEnumerable<JArray> productsList;
        ...
        private async Task<bool> SyncProductsAsync(string logHeader)
        {
            ...
            if (productsList != null)
            {
                ...
                {
                    productCodes.Add(product[2].ToString().TrimEnd('.'));
                }
            ...
            where TModel : DomainModel
        {
            ...
            IEnumerable<JArray> linkstoreWhat = null;
            ...
            try
            {
                ...
                linkstoreWhat = JsonConvert.DeserializeObject<IEnumerable<JArray>>(
